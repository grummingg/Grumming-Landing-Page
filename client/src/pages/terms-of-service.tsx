...
const sections = [
  ...
  },
  {
    ...
    bg: "bg-purple-500/10",
    content: [
      "Bookings are subject to availability and confirmation by the provider.",
      ...
      "Late cancellations or no-shows may result in cancellation fees as determined by the provider.",
      "Repeated no-shows may result in account restrictions or suspension.",
      "Providers reserve the right to cancel bookings due to unforeseen circumstances.",
    ],
  ...
  },
  {
    ...
    content: [
      ...
      "Payment is required at the time of booking or at the business, depending on the service.",
      ...
      "Refund amounts may be subject to cancellation fees as per provider policies.",
  ...
  },
  {
    ...
    content: [
      ...
      "Harass, abuse, or harm staff or other users.",
  ...
  },
  {
    ...
    intro: "Businesses listed on Grumming must:",
  },
  {
    number: "7",
  ...
  },
  {
    ...
    bg: "bg-cyan-500/10",
    content: [
      "Grumming acts as an intermediary platform connecting users with salons, spas, and studios.",
      "We are not liable for the quality, safety, or legality of services provided by partners.",

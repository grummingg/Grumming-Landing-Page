...
import { Send, Mail, User, MessageSquare, FileText, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <h1 className="text-4xl font-bold mb-2 text-foreground" data-testid="text-contact-title">
          Get in Touch
        </h1>
        <p className="text-muted-foreground mb-10" data-testid="text-contact-description">

        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {perks.map((perk, index) => (
              ...
              >
                <div className="bg-muted/40 dark:bg-[#1e293b] rounded-md p-6" data-testid={`card-perk-${perk.title.toLowerCase().replace(/\s+/g, "-")}`}>
                  <div className={`w-10 h-10 rounded-xl ${perk.bg} flex items-center justify-center mb-4`}>

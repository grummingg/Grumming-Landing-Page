    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <a
            href="#"
            className="inline-flex items-center gap-4 bg-black/90 backdrop-blur-sm rounded-xl px-5 py-3 border border-white/10 shadow-lg hover-elevate"
          ...
          >
            ...
            <div className="text-left">
              <div className="text-[11px] text-white/70 uppercase tracking-wider font-medium">Get it on</div>
              <div className="text-xl font-bold text-white tracking-tight">Google Play</div>
            </div>
          </a>
          <a
            href="#"
          ...
          >
            ...
            <div className="text-left">
              <div className="text-[11px] text-white/70 uppercase tracking-wider font-medium">Download on the</div>
              <div className="text-xl font-bold text-white tracking-tight">App Store</div>
            </div>
          </a>
        </motion.div>
      </div>

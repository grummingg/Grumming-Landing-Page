...
export function AppDownload() {
  return (
    <section id="download" className="py-16 sm:py-20 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          >
            <h2
              className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 leading-snug"
              data-testid="text-download-title"
            >
              Download the app now!
            </h2>

            <p className="text-sm sm:text-base text-gray-500 mb-6 max-w-xs leading-relaxed">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="#"
                className="inline-flex items-center gap-2 bg-gray-900 rounded-lg px-3.5 py-2 hover-elevate transition-transform"
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[8px] text-white/60 uppercase tracking-wider font-medium">Get it on</div>
                  <div className="text-xs font-semibold text-white -mt-0.5">Google Play</div>
                </div>
              </a>
              <a
                href="#"
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-[8px] text-white/60 uppercase tracking-wider font-medium">Download on the</div>
                  <div className="text-xs font-semibold text-white -mt-0.5">App Store</div>
                </div>
              </a>
            </div>
          </motion.div>

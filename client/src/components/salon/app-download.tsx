        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          >
            <div className="relative" aria-hidden="true">
              <div className="w-44 h-[340px] bg-gradient-to-b from-muted to-muted/80 rounded-[2rem] p-1.5 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.15)] dark:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.4)] relative border border-border">
                <div className="w-full h-full bg-background rounded-[1.75rem] flex flex-col items-center justify-center px-4 py-6 relative">
                  <div className="absolute top-2.5 left-1/2 -translate-x-1/2 w-14 h-4 bg-hero rounded-full" aria-hidden="true" />
                ...
                <div className="absolute bottom-1.5 left-1/2 -translate-x-1/2 w-16 h-1 bg-muted-foreground/40 rounded-full" aria-hidden="true" />
              </div>
            </div>
          </motion.div>

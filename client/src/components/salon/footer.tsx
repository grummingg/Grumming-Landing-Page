    ...
    <footer className="bg-white dark:bg-[#0f172a] text-foreground dark:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-10 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8">
          <div className="lg:col-span-12 flex flex-col sm:flex-row items-start justify-between gap-8 mb-10">
            <div>
          ...
          <div className="lg:col-span-12 grid grid-cols-2 sm:grid-cols-4 gap-8">

            ...
            {units.map(({ label, value }, i) => (
              <div key={label} className="flex items-start gap-4 sm:gap-8">
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 sm:w-24 sm:h-24 rounded-2xl bg-primary flex items-center justify-center shadow-md">
                    <span
                      className="text-2xl sm:text-4xl font-bold text-primary-foreground tabular-nums"
